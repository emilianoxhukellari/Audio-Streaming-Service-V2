...
namespace Client_Application.Client.Event
{
    ...
    public class LongNetworkRequestArgs : EventArgs
    {
    ...
    public class RegisterErrorsUpdateArgs : EventArgs
    {
        public List<string> Errors { get; set; } = new List<string>();
    }

    public class ResetPageArgs : EventArgs
    {
        public PageType PageType { get; set; }
    }
    public class UpdatePageArgs : EventArgs
    {
        public PageType PageType { get; set; } = PageType.LogIn;
    }
    ...
    public class AddSongToQueueArgs : EventArgs
    {
        public Song? Song { get; set; }
    }

    public class PlaySongNextArgs : EventArgs
    {
        public Song? Song { get; set; }
    }
