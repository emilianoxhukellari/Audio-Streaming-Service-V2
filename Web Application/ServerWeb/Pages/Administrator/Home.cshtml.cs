...
namespace ServerWeb.Pages.Administrator
{
    ...
    public class HomeModel : PageModel
    {
        ...
        public async Task OnGetAsync()
        {
            ...
            NumberOfSolvedIssues = await _issueManagerService.GetNumberOfIssuesAsync(IssueType.Solved);
            NumberOfUnsolvedIssues = await _issueManagerService.GetNumberOfIssuesAsync(IssueType.Unsolved);
